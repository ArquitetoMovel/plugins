...
Construir um *Plugin de IA* compatível com o GitHub Copilot CLI, Claude Code e Cursor, que seja capaz de gerar um Documento de Requisitos de Produto (PRD) a partir de um conjunto de perguntas e respostas.

## Funcionalidades

O plugin deve ser capaz de entrevistar o usuário com as seguintes perguntas para coletar as informações necessárias para a criação do PRD:

### Existem dois tipos de PRDs que devem ser segregados em SKILLS diferentes

1. Geral, sobre o produto como um todo.
2. Funcional, sobre uma funcionalidade específica do produto.

### Para o PRD Geral, as perguntas são
...
- Qual é o problema que esse produto resolve e por que ele importa?
...
- Qual é o roadmap desse projeto ?
- Quem está envolvido e qual é o papel de cada um?
- Como esse produto se conecta a estratégia da empresa?

#### Contexto adicional para o PRD Geral

O PRD Geral é um documento de alto nível que descreve a visão, os objetivos e o escopo do produto como um todo. Ele é usado para alinhar as partes interessadas e orientar o desenvolvimento do produto.
Caso o plugin seja executado no repositório do produto, ele pode usar o histórico de commits, as issues e os pull requests, e os próprios fontes para obter informações adicionais sobre o produto e enriquecer o PRD.

#### Formato de saída do PRD Geral

O PRD Geral deve ser gerado em formato Markdown, seguindo a estrutura abaixo:
...
### Para o PRD Funcional, as perguntas são

#### Objetivo do PRD Funcional
